...
import macNCheeseMain from '../assets/macncheesemain.png';
...
const ProductPage1 = () => {
  ...
  const product = {
    ...
    originalPrice: 19.90,
    currency: "€",
    description: "Romig, rijk en decadent! Deze lobster mac 'n cheese is de ultieme decadente verrassing. Romige kaassaus, lekker veel kaas en pasta vormen de perfecte drager voor grote stukken kreeftenvlees. Hij hoeft maar 15 minuten in de oven op 180C.",
    ingredients: "Macaroni, verse kreeft, roomkaas, cheddar kaas, boter, melk, bloem, zout, peper, peterselie",
    allergens: "Melk, gluten, schaaldieren",
    weight: "400g",
    preparation: "Bevroren. Verwarm in de oven op 180°C gedurende 25-30 minuten of in de magnetron gedurende 4-5 minuten.",
    storage: "Bevroren bewaren bij -18°C. Na ontdooien binnen 24 uur consumeren.",
    category: "Specials",
    ...
    <div className="product-page">
      <div className="container">
        ...
        <nav className="breadcrumb">
          ...
          <span className="breadcrumb-separator">/</span>
          <Link to="/specials" className="breadcrumb-link">Specials</Link>
          <span className="breadcrumb-separator">/</span>
