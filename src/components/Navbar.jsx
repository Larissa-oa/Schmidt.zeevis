        ...
        <div className="container">
          ...
          <div className={`mobile-nav ${isMenuOpen ? 'active' : ''}`}>
            <div className="mobile-nav-content">
              <Link to="/" className="mobile-nav-link">Webwinkel</Link>
              <Link to="/on-s-verhaal" className="mobile-nav-link">Ons verhaal</Link>
              <Link to="/de-winkel" className="mobile-nav-link">De winkel</Link>
              <Link to="/contact" className="mobile-nav-link">Contact</Link>
              <Link to="/account" className="mobile-nav-link">Account</Link>
              <Link to="/winkelwagen" className="mobile-nav-link">Winkelwagen</Link>
            </div>
          </div>
        </div>
      </nav>
